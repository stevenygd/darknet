...
void forward_detection_layer(const detection_layer l, network_state state)
{
    ...
    if(state.train){
        ...
        *(l.cost) = pow(mag_array(l.delta, l.outputs * l.batch), 2);
        ...
        fprintf(stderr, "Loss: %f, Detection Avg IOU: %f, Pos Cat: %f, All Cat: %f, Pos Obj: %f, Any Obj: %f, count: %d\n", *(l.cost), avg_iou/count, avg_cat/count, avg_allcat/(count*l.classes), avg_obj/count, avg_anyobj/(l.batch*locations*l.n), count);
        // printf("Loss: %f, Detection Avg IOU: %f, Pos Cat: %f, All Cat: %f, Pos Obj: %f, Any Obj: %f, count: %d\n", *(l.cost), avg_iou/count, avg_cat/count, avg_allcat/(count*l.classes), avg_obj/count, avg_anyobj/(l.batch*locations*l.n), count);
    }
}
